...
NOTE: At this point in time, lattice requires docker images to be served from https://hub.docker.com. It means you have to register and in fact push your image there to deploy. If you happen to have a GitHub account, you can easily create a DockerHub account that matches.
