...
+
* A docker setup as described in link:/guide/gs/spring-boot-docker
...
With Lattice set up and a sample web app installed, now you can install a Spring Cloud module that interacts with Lattice.
...
NOTE: At this point in time, lattice requires docker images to be served from https://hub.docker.com. It means you have to register and in fact push your image there to deploy.
